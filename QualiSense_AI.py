...
<style>
    ...
    .app-title {
        color: #17a2b8;
        background: linear-gradient(120deg, #17a2b8 0%, #48cae4 100%);
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
        font-size: 3rem !important;
        font-weight: 700 !important;
        margin-bottom: 1.5rem !important;
        text-shadow: 2px 2px 4px rgba(23, 162, 184, 0.1);
    }
    .stButton>button {
...
def create_welcome_page():
    ...
    with col2:
        ...
        st.markdown("""
        ### 💝 Support Development
        If you find QualiSense-AI valuable, consider supporting its development:
        
        [![Donate with PayPal](https://www.paypalobjects.com/en_US/i/btn/btn_donate_LG.gif)](https://www.paypal.com/paypalme/swapnil.morande@icloud.com)
        """)
...
def main():
    ...
    if not api_key:
        ...
        [Donate via PayPal](https://www.paypal.com/paypalme/swapnil.morande@icloud.com){: .donate-btn}
        """)
        return
